...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Product item4 = new HotDrink("Black tea", 50,80);
        Product item5 = new HotDrink("Green tea", 55,75);
        Product item6 = new HotDrink("Coffee Cappuccino", 120,70 );
        Product item7 = new HotDrink("Coffee Espresso", 150, 70);
